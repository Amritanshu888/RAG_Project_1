...
from src.config.config import Config ## This Config is nothing but the Config class that i have created over there
...
def main():
    ...
    if not st.session_state.initialized:
        with st.spinner("Loading System..."):
            rag_system, num_chunks = initialize_rag() ## This initialize RAG will actually help us to prepare the entire vectorstore
            if rag_system:
